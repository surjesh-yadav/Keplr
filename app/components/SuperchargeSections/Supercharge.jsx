        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-1 gap-4">
          ...
          >
            <div className="md:w-1/2">
              ...
              />
              <h3 className="text-2xl mt-5 text-white">Dollar House 1 Plan</h3>
          ...
          >
            <div className="md:w-1/2 ">
              <img
                ...
                className="icon-medium"
              />
              <h3 className="text-2xl  text-white  mt-5">Dollar House 5 Plan</h3>
          ...
          >
            <div className="md:w-1/2 ">
              <img
                ...
                className="icon-medium"
              />
              <h3 className="text-2xl mt-4  text-white">Dollar House 15 Plan</h3>
          ...
          <div data-aos="fade-up"
            ...
            className="df-item py-8 px-8 p-6 md:flex md:space-x-10 justify-around">
             ...
             <div className="md:w-1/2 ">
              <h3 className="text-3xl font-bold mt-5 md:mt-0  text-white "> <span className="text-[#b96c33]">Dollar house </span>dashboard</h3>
              <p className="text-white mt-3 max-w-[350px]">
              ...
              <ul className="mt-5 dashboard_ul  text-white">
                ...
                <li className=" text-white">Track of missed, received, spilled, freezed rewards</li>
                <li className=" text-white">
                Wallet connectivity
                </li>
                <li className=" text-white">
              ...
              <button className="border  text-white border-[#b96c33] px-5 mt-6 py-2 rounded-full">Go to dashboard</button>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                  <div className="box_small bg-[#0F0F0F] rounded-2xl p-6">
                      <img className="w-10" src="/dh1.svg"/>
                       <h3 className="text-lg mt-3  text-white">DH-Decentralized Exchange</h3>
